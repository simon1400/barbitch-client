...
export const Banner = ({
  ...
  return (
    <section className={'pb-10 md:pb-15'}>
      <Container size={'lg'}>
        <div
          className={`relative text-center px-7 md:px-13.5 py-9 md:py-18 z-10 flex items-center justify-center flex-col bg-gradient-to-t from-[rgba(231,30,110,1)] to-[rgba(255,0,101,0.5)]`}
        >
          {data.image && (
            <div
              className={
